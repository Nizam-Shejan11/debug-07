...
const typeController = (e) => {
  ...
  if (newLetterCorrect) {
    ...
    /*            debugged:             */
    /* ------------------------------- */
    /* If user types wrong character, We will increment error count by 1 */
...
const gameOver = () => {
  ...
  /*            debugged:             */
  /* ------------------------------- */
  /* rounded the seconds shown in modal */
...
setInterval(() => {
  ...
  /*            debugged:             */
  /* ------------------------------- */
  /* Another rounded the seconds shown in modal */
